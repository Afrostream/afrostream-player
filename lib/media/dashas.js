...
videojs.Dashas = videojs.Flash.extend({
  ...
  init: function (player, options, ready) {
    var serverUrl = options.source ? videojs.Dashas.buildMetadataUrl(options.protData, options.source.src) : '';
    var customData = options.source ? videojs.Dashas.buildOptData(options.protData, options.source.src) : '';
...
videojs.Dashas.getDRMData = function (protData, source) {
  ...
  return {
    ...
    serverUrl: serverUrl,
    assetId: videojs.Dashas.extractAssetId(source),
    variantId: ''
  }
};

videojs.Dashas.buildMetadataUrl = function (protData, source) {
  var data = videojs.Dashas.getDRMData(protData, source);
...
videojs.Dashas.buildOptData = function (protData, source) {
  return videojs.Dashas.getDRMData(protData, source).customData
};
