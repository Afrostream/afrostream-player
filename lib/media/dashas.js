...
videojs.Dashas = videojs.Flash.extend({
  ...
  init: function (player, options, ready) {
    ...
    this.on('error', videojs.bind(this, function () {
      this.clearInterval(this.metricsInterval);
    }));
    this.on('loadedmetadata', videojs.bind(this, this.onInitialized));
    this.on('firstplay', videojs.bind(this, this.selectDefaultTrack));
  }
});
